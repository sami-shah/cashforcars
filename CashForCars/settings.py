"""
Django settings for CashForCars project.
...
SECRET_KEY = 'django-insecure-)d)hv@lqr1bw0r-q_)yt0uhts%=7e#zarka55e4*ijz2t3_1y2'
...
WSGI_APPLICATION = 'CashForCars.wsgi.application'
